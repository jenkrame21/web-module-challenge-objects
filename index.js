...
function createMenuItem(name, price, category){
    ...
    return {name, price, category}// more menu items with the same format as the items above
}
console.log(createMenuItem("Pizza", 15, "Dinner"));

/* Task 1b: use your function to create 3 more menu items. You may add any items to the menu that you'd like */

console.log(createMenuItem("Hotdog", 13, "Lunch"));
...
*/
function getReviewByIndex(restReviews, index) {
    
  return `${restReviews[index].name} gave the restaurant a ${restReviews[index].rating} star review and their feedback was: ${restReviews[index].feedback}`//string in the format `{name} gave the restaurant a {rating}, and their feedback was: {feedback}`
  }
